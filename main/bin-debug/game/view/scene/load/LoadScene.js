...
var LoadScene = (function (_super) {
    ...
    //加载资源
    LoadScene.prototype.loadRes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("加载分包资源到缓存");
                        return [4 /*yield*/, RES.loadGroup("game")];
                    case 1:
                        _a.sent();
                        //跳转到主页
    ...
    //加载进度
    LoadScene.prototype.onLoadProgress = function (event) {
        this.setProgress(Math.round(event.itemsLoaded / event.itemsTotal) * 100);
    };
    //加载完成
    LoadScene.prototype.onLoadComplete = function (event) {
        platform.hideLoading();
        App.SceneManager.destoryScene(LoadScene);
        App.SceneManager.open(HomeScene);
    };
