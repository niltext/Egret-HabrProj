...
declare const wx: {
     ...
     * 获取系统信息
     */
    getSystemInfo(object: {success:(res:any)=>void}): void;
    /**
     ...
     */
    onShareAppMessage(callback: (res)=>void): void;
    /**
    ...
    showLoading(object: {}): void;
    /**
     * 参数
     */
    showActionSheet(object: {}): void;
    /**
     * 隐藏键盘
     */
     ...
     * 监听窗口尺寸变化事件
     */
    onWindowResize(callback: (res)=>void): void;
    /**
     * 取消监听窗口尺寸变化事件
     */
 ...
 * 激励视频广告组件
 */
declare interface RewaredVideoAd {
    show():Promise<Object>;
    onLoad(callback:() => void);
    onError(err);
    load();
    onClose(callback:(res:any)=>void);
}

/**分包加载状态 */
declare interface LoadSubpackageTask{
    onProgressUpdate(callback:(res:any) => void);
}
